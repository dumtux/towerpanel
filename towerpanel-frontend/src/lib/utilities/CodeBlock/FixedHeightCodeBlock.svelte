...
import { clipboard } from '@brainandbones/skeleton/actions/Clipboard/clipboard';
// Props
...
<div class="code-block {classesBase}" data-testid="code-block">
	...
	<!-- Pre/Code -->
	<pre class="code-block-pre {cPre}" style="min-height: 28em; white-space: pre; word-break: normal; word-wrap: normal;">
		<code class="code-block-code language-{language}">{#if formatted}{@html displayCode}{:else}{code.trim()}{/if}</code>
	</pre>
</div>
{/if}
